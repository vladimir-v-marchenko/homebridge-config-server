$(function() {
	 ...
	 */
	function post() {
		var device = {bridge:{}, accessories:[], platforms:[]};
		
    // bridge
    device["bridge"]["name"] = $("input.bridge-name").val();
    device["bridge"]["username"] = $("input.bridge-username").val();
    device["bridge"]["port"] = $("input.bridge-port").val();
    device["bridge"]["pin"] = $("input.bridge-pin").val();
